...
// Creator: Kharaj Chakraborty 23.10.2021-2.10.2023
int main()
{
...
//clear screen
        ...
        //Create Receipt File
        sprintf(fname[0], "F:/Codes/C/Restaurant Receipt Generator/Receipts/%d_%02d_%02d_%02d-%02d-%02d.txt", date.tm_year + 1900, date.tm_mon + 1, date.tm_mday, date.tm_hour, date.tm_min, date.tm_sec );
        ...
        //Saving Receipt Data
        r_data = fopen("F:/Codes/C/Restaurant Receipt Generator/Data/receipt_data.txt","a+");
...
r_details: // Receipt Entry Data Beginning      
        
        receipt_loc = fopen("F:/Codes/C/Restaurant Receipt Generator/Data/receipt_data.txt","r");
        ...
        if (opt2 == 1)
        {
            ...
            sprintf(file_loc[0], "F:/Codes/C/Restaurant Receipt Generator/Receipts/%s", file_nme[0] );
